...
@section('content')
    <div class="container mt-4">
        ...
        <div class="d-flex align-items-center position-relative my-1 mb-3">
            <input type="text" class="form-control table-search form-control-solid w-250px ps-15" placeholder="Search cancelled orders..." />
        </div>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            console.log('Cancelled Orders DataTable ready');
            const BASE_URL = "{{ url('/') }}";
            ...
            let table = $('#orderDatatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: BASE_URL + '/dashboard/orders/declined',
                    type: 'GET',
                    data: function(d) {
                        d._token = CSRF_TOKEN;
                    },
                ...
                pageLength: 25,
                language: {
                    emptyTable: 'No cancelled orders found.'
                },

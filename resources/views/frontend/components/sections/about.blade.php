  ...
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-6 order-2 order-lg-1 content">
        ...
        <p class="fst-italic">
          At Foodymat, we believe that great food starts with the finest ingredients. Our commitment to quality and freshness sets us apart in the food delivery industry.
        </p>
        <ul>

    ...
    <body class="font-sans antialiased bg-gray-50">
        <div class="min-h-screen flex">
            ...
            <div class="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-white">
                <div class="mx-auto w-full max-w-sm lg:w-96">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mb-8">Join us and start your food journey</p>
                        ...
                        <form method="POST" action="{{ route('register') }}" class="space-y-6">
                            ...
                            <div class="flex items-center">
                                ...
                                <label for="terms" class="ml-2 text-sm text-gray-600">
                                    I agree to the 
                                    <a href="#" class="font-medium hover:underline" style="color: var(--accent-color);">Terms of Service</a>
                                    and 
                                    <a href="#" class="font-medium hover:underline" style="color: var(--accent-color);">Privacy Policy</a>
                                </label>
                            </div>
                        ...
                        <div class="mt-8 text-center">
                            <p class="text-sm text-gray-600">
                                ...
                                <a href="{{ route('login') }}" class="font-medium hover:underline transition-colors duration-200" style="color: var(--accent-color);">
                                    Sign in here
                                </a>
                            </p>
                        </div>
            ...
            <div class="hidden lg:block relative flex-1">
                <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('{{ asset('frontend/img/gallery/gallery-2.jpg') }}');">
                    <div class="absolute inset-0 bg-black opacity-40"></div>
                </div>
                <div class="relative h-full flex flex-col justify-center items-center px-12 text-white z-10">
                    <div class="max-w-md text-center">
                        <!-- Illustration Icons (optional, can remove for pure image) -->
                        ...
                        <p class="text-lg text-white text-opacity-90 leading-relaxed">
                            Create an account to unlock exclusive deals, track your orders, and enjoy personalized recommendations from your favorite restaurants.
                        </p>

                        <!-- Decorative Elements (optional, can remove for pure image) -->
